        ...
        <main className="bg-background min-h-screen text-foreground py-24 px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl mx-auto space-y-8">
                <header className="space-y-4 border-b border-white/10 pb-8">
                    ...
                    <p className="text-black">Last Updated: February 2026</p>
                </header>
                ...
                <section className="space-y-6 text-gray-300 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">7. Data Sharing</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">12. Policy Updates</h2>

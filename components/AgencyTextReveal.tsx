    ...
    return (
        <section className="bg-white py-20 overflow-hidden relative">
            ...
            <div className="relative w-full h-[300px] my-12 flex items-center justify-center overflow-hidden z-0 opacity-10 md:opacity-100">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] bg-[#2ba0fe] text-white -rotate-5 py-4 shadow-lg z-0">
                    <div className="absolute top-0 left-0 w-64 h-full bg-gradient-to-r from-[#2ba0fe] to-transparent z-10" />
                    <div className="absolute top-0 right-0 w-64 h-full bg-gradient-to-l from-[#2ba0fe] to-transparent z-10" />
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] bg-[#151515] text-white rotate-5 py-4 shadow-lg z-10">
                    <div className="absolute top-0 left-0 w-64 h-full bg-gradient-to-r from-[#151515] to-transparent z-10" />
                    <div className="absolute top-0 right-0 w-64 h-full bg-gradient-to-l from-[#151515] to-transparent z-10" />

...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-start pt-32 md:pt-[160px] pb-10 md:pb-20 overflow-hidden bg-background">
            {/* Background Elements */}
            ...
            >
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center w-full mb-12">
                    ...
                    <div className="flex flex-col items-start text-left lg:pl-4 lg:pr-4">
                        {/* Main Heading */}
                        <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-[72px] font-cal font-bold tracking-normal text-foreground leading-[1.1] mb-6 md:mb-8 w-full">
                            ...
                            <motion.span variants={item} className="inline-block text-brand-blue">
                                <TypingAnimation
                        ...
                        {/* Subtext description */}
                        <motion.p variants={item} className="text-[18px] text-muted-foreground max-w-xl mb-8 leading-relaxed">

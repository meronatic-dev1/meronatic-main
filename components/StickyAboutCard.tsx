    ...
    return (
        ...
        >
            <motion.div
                ...
                className="bg-[#1a1a1a] text-white rounded-[24px] md:rounded-[48px] overflow-hidden w-full min-h-[70vh] h-auto md:h-[90vh] border border-white/10 shadow-2xl origin-top flex flex-col justify-center items-center text-center p-6 md:p-20 relative"
            >

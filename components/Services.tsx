                        ...
                        {SERVICES.map((service, i) => (
                            <div key={i} className="group border-b border-white/10 pb-12 last:border-0 last:pb-0">
                                <div className="flex items-start justify-between mb-4">
                                    <h3 className="text-2xl font-cal font-semibold group-hover:text-brand-orange transition-colors duration-300">
                                        {service.title}
                                    </h3>
                                    <ArrowRight className="text-white/30 group-hover:text-brand-orange transition-colors duration-300" />
                                </div>

    ...
    <section className="band band--ink" style={{ position: "relative", overflow: "hidden" }}>
      ...
      <div className="shell" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: "800px" }}>
          ...
          <p className="mono eyebrow">{t("services.hero.eyebrow")}</p>
          <h1 className="d1" style={{ marginBlock: "var(--s2) var(--s3)" }}>
            {t("services.hero.h1")}
          </h1>
          <p className="lede">{t("services.hero.lede")}</p>
          ...
          >
            ...
            <a className="btn btn--ghost" href="/tools#planner">
              <span>{t("services.hero.planner")}</span>
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              />
              {isRTL ? "٧ خطوط خدمة متكاملة" : "7 Integrated Service Lines"}
            </span>
            ...
            >
              ...
              />
              {isRTL ? "تنفيذ مرخص ومباشر" : "Direct & Licensed Delivery"}
            </span>

...
const FAQS: FaqItem[] = [
  { qKey: "hww.faq.1.q", aKey: "hww.faq.1.a" },
  { qKey: "hww.faq.2.q", aKey: "hww.faq.2.a" },
  { qKey: "hww.faq.3.q", aKey: "hww.faq.3.a" },
  { qKey: "hww.faq.4.q", aKey: "hww.faq.4.a" },
];

export function HowWeWorkFaq() {
  const { t } = useLanguage();
    ...
    <section className="band band--ink" id="faq" style={{ borderTop: "1px solid rgba(255, 255, 255, 0.08)" }}>
      <div className="shell">
        <div className="sec-head sec-head--split rv">
          <div>
            <p className="mono eyebrow">{t("hww.faq.eyebrow")}</p>
            <h2 className="d2">{t("hww.faq.h")}</h2>
          </div>
        </div>
